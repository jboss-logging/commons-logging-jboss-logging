...
Want to contribute to the commons-logging-jboss-logging? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to commons-logging-jboss-logging are licensed under the
...
commons-logging-jboss-logging has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
